...
INSERT INTO `my_aspnet_membership` VALUES (1,'andres.s.menendez@gmail.com','','123456!','InxZh9Q62ATDgwbbkJq0Fw==',0,'teste','testado',1,'2016-01-13 22:09:15','2016-01-13 22:08:54','2016-01-12 20:06:10','2016-01-12 20:06:10',0,'2016-01-12 20:06:10',0,'2016-01-12 20:06:10',0,'2016-01-12 20:06:10'),(2,'admin@admin.com','','admin','Nm451CK3L8rZhbnboAFNKA==',0,'teste','testado',1,'2016-01-13 21:28:45','2016-01-13 21:28:45','2016-01-12 23:14:01','2016-01-12 23:14:01',0,'2016-01-12 23:14:01',0,'2016-01-12 23:14:01',0,'2016-01-12 23:14:01');
...
INSERT INTO `my_aspnet_users` VALUES (1,1,'andres',0,'2016-01-13 22:09:15'),(2,1,'admin',0,'2016-01-13 21:28:45');
...
INSERT INTO `my_aspnet_usersinroles` VALUES (1,2),(1,3),(2,1);
...
INSERT INTO `tb_ativar_perfil` VALUES (2,1,'A');
...
CREATE TABLE `tb_turma` (
  ...
  CONSTRAINT `fk_tb_turma_tb_usuario1` FOREIGN KEY (`Id_Usuario`) REFERENCES `tb_usuario` (`Id_Usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tb_usuario` VALUES (1,'Andrés Silva Menéndez','andres.s.menendez@gmail.com',NULL,'andres'),(2,'Administrador do Sistema','admin@admin.com',NULL,'admin');
...
-- Dump completed on 2016-01-13 22:10:07
